class PlatformsController < ApplicationController
  def index
    ...
    Platform.update_all({:is_available_in_cloud => 0})
    ...
    SauceWhisk::Sauce.platforms.each do |p|
      ...
      Platform.find_or_create_by(test_browser_id: browser,test_operating_system_id: os).update({:is_available_in_cloud => 1})
    end
    
    @platforms = Platform.all(:include => [:test_operating_system,:test_browser])
  end
end